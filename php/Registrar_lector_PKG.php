...
$stmt = oci_parse($conexion, "BEGIN GESTION_LECTORES_PKG.PRC_InsertarLector(:cedula, :primerNombre, :segundoNombre, :primerApellido, :segundoApellido, TO_DATE(:fechaNacimiento, 'YYYY-MM-DD'), :departamento, :ciudad, :calle, :numeroCasa, :barrio, :numeroTelefono, :correo, :mensaje); END;");
